...
export const Selectors = {
  SAVE_AND_RESET_ALL_VALUES_BUTTON_SELECTOR: '[data-test="dhis2-uicore-buttonstrip"] [data-test="dhis2-uicore-button"]',
...
export const dropdownValues = [
  ['Global', 'Per Org Unit', 'Per program', 'Per OU and program'], // Options for the first element
  ['Any time period', 'Last month', 'Last 3 months', 'Last 12 months'], // Options for the second element
  ['Any time period', 'Last month', 'Last 3 months', 'Last 12 months'] // Options for the third element
];